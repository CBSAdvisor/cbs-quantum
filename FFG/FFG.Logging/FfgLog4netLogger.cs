...
namespace FFG.Logging {
    [Serializable]
    public class FfgLog4netLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(FfgLog4netLogger);

        public FfgLog4netLogger(log4net.Core.ILogger logger, FfgLog4netFactory factory) {
            Logger = logger;
            Factory = factory;
        }

        internal FfgLog4netLogger() {
        }

        internal FfgLog4netLogger(ILog log, FfgLog4netFactory factory)
        ...
        protected internal FfgLog4netFactory Factory { get; set; }

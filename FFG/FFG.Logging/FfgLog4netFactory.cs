...
namespace FFG.Logging {
    public class FfgLog4netFactory : AbstractLoggerFactory {
        private static bool _isFileWatched = false;

        public FfgLog4netFactory() 
            : this(ConfigurationManager.AppSettings["log4net.Config"]) { }

        public FfgLog4netFactory(string configFilename)
        {
        ...
        public override Castle.Core.Logging.ILogger Create(string name) {
            return new FfgLog4netLogger(LogManager.GetLogger(name), this);
        }
    }
}
